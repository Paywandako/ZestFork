...
class TodoController extends GetxController {
  ...
  // New method to update recurring todo
  Future<void> updateRecurringTodo(
    Todos todo,
    Tasks task,
    String title,
    String desc,
    ...
    isar.writeTxnSync(() {
      ...
      todo.recurrenceDayOfMonth = recurrenceDayOfMonth;
      todo.recurrenceEndDate = recurrenceEndDate;
      todo.recurrenceCount = recurrenceCount;
      todo.originalDueDate = date;
      isar.todos.putSync(todo);
      todo.task.saveSync();
    });
  ...
  // New method to end recurrence for a todo
  Future<void> endRecurrence(Todos todo) async {
    isar.writeTxnSync(() {
    ...
    EasyLoading.showSuccess('recurrenceEnded'.tr, duration: duration);
  }
